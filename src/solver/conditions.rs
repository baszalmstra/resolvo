...
use crate::{
    Condition, ConditionId, ConditionalRequirement, Interner, LogicalOperator, SolvableId,
    VersionSetId,
    internal::{arena::ArenaId, id::SolvableOrRootId},
};
...
#[derive(Debug, Clone)]
pub(crate) enum DeferredConjunct {
    ...
    Empty {
        ...
        all_candidates: Vec<SolvableId>,
    },
}

impl DeferredConjunct {
    /// The version set inside the condition that this conjunct represents.
    ...
    pub fn candidates(&self) -> &[SolvableId] {
        match self {
...
pub(crate) struct DeferredRequirement {
    ...
    pub solvable_id: SolvableOrRootId,
    ...
    pub disjunct: Vec<DeferredConjunct>,
}
...
pub(crate) fn condition_disjunct_holds(
    disjunct: &[DeferredConjunct],
    mut is_positively_decided: impl FnMut(SolvableId) -> bool,
) -> bool {
